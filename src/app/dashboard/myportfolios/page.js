    ...
    <div className="parent p-2 px-2 flex flex-col gap-2 md:gap-5">
      <div className="flex flex-col md:flex-row justify-between">
        <div className="flex flex-col ">
          <h1 className="text-3xl font-bold bg-linear-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent md:text-6xl">My Portfolios</h1>
          <p className="ml-0.8 md:text-lg">Manage your portfolio collection</p>
        </div>
